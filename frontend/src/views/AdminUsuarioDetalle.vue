  ...
  <div class="p-4">
    ...
    <section class="mt-6">
      ...
      <p v-else class="text-sm text-gray-600">
        Solo un superadmin puede cambiar la contraseña de un superadmin.
      </p>
    </section>
...
const rolActual = computed(() => {
  ...
  return me?.perfil?.rol || me?.rol || ''
})
const esTargetSuperAdmin = computed(() => user.value?.perfil?.rol === 'super_admin' || user.value?.is_superuser)
const puedeCambiarPwd = computed(() => !esTargetSuperAdmin.value || rolActual.value === 'super_admin')
