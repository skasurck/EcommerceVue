...
class Producto(models.Model):
    ...
    category_ai_main = models.CharField(max_length=120, null=True, blank=True)
    category_ai_sub = models.CharField(max_length=255, null=True, blank=True)
    category_ai_leaf = models.CharField(max_length=120, null=True, blank=True)
    category_ai_match_type = models.CharField(max_length=20, null=True, blank=True)
